...
SynthParams::SynthParams()
    ...
    , sourceLevel("sourceLevel", "sourceLevel", "sourceLevel", "", 0.0f, 1.0f, 0.0f)
    ...
    , outputLevelLeft("output level left", "outputLevelLeft", "outputLevelLeft", "", 0.0f, 1.0f, 0.0f)
    , outputLevelRight("outputlevel right", "outputLevelRight", "outputLevelRight", "", 0.0f, 1.0f, 0.0f)
